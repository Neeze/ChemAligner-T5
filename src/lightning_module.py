...
from backbones.lang.chemaligner_t5 import T5ForConditionalGeneration
import torch
...
class T5Model(pl.LightningModule):
    ...
    def training_step(self, batch, batch_idx):
        ...
        self.log("train/cotrastive_loss", contrastive_loss, prog_bar=False, logger=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log("val/cotrastive_loss", contrastive_loss, prog_bar=False, logger=True)

        # Monitor loss is eval_loss
        self.log('eval_loss', lm_loss, prog_bar=False, logger=False)
